...
class UserDash extends Component {
    ...
    render() {
        return (
            ...
            <div>
                <Toast />
                <UserProfile showUser = {this.state.showUser}>
                    ...
                    <li  className="pointer"><a className="waves-effect waves-purple" onClick={this.ShowComponentHandler.bind(this, "showUser")}><i className="material-icons" style={this.state.showUser ? { color: "red" } : null}>person</i>Edit Profile</a></li>
                    <li  className="pointer"><a className="waves-effect waves-purple" onClick={this.ShowComponentHandler.bind(this, "showStats")}><i className="material-icons" style={this.state.showStats ? { color: "red" } : null}>insert_chart</i>Stats</a></li>
                    <li  className="pointer"><a className="waves-effect waves-purple" href="/" onClick={this.signout}><i className="material-icons">exit_to_app</i>Signout</a></li>
